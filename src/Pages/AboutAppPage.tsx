...
const AboutAppPage = () => {
  return (
    <PageContainer>
      <Text textAlign="center" fontWeight="bold" fontSize="2xl" marginTop={2}>
      ...
      <Paragraph>
        ...
        including buying and selling items online. Our app is born out of the
        need to bridge the gap that platforms like WhatsApp couldn't fill – a
        place where all students can easily connect.
      </Paragraph>
      <Paragraph>
        ...
        opportunity to not only explore the academic realm but also tap into
        your entrepreneurial potential. Our app allows you to start a business
        without the need for a physical store, save on overhead costs, and
        increase your visibility within the university network.
      </Paragraph>
      <Paragraph>
        ...
        skills or valuable insights. Reach out to us on WhatsApp at
        +254745889801.
      </Paragraph>
      <Paragraph>
